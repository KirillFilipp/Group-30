  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-2 col-md-4 col-sm-6 project-author">
        <figure>
          <img class="img-project-author" src="./imagesComponents/kirillfilipp.jpeg" alt="kirillfilipp">
          <figcaption>GitHub: <a href="https://github.com/kirillfilipp" target="_blank">kirillfilipp</a></figcaption>
        </figure>
      </div>
      <div class="col-lg-2 col-md-4 col-sm-6 project-author">
        <figure>
          <img class="img-project-author" src="./imagesComponents/mozgoen.jpeg" alt="mozgoen">
          <figcaption>GitHub: <a href="https://github.com/mozgoen" target="_blank">mozgoen</a></figcaption>
        </figure>
      </div>
      <div class="col-lg-2 col-md-4 col-sm-6 project-author">
        <figure>
          <img class="img-project-author" src="./imagesComponents/kozyritskiy.jpeg" alt="kozyritskiy">
          <figcaption>GitHub: <a href="https://github.com/kozyritskiy" target="_blank">kozyritskiy</a></figcaption>
        </figure>
      </div>
      <div class="col-lg-2 col-md-4 col-sm-6 project-author">
        <figure>
          <img class="img-project-author" src="./imagesComponents/kulinar310.jpeg" alt="kulinar310">
          <figcaption>GitHub: <a href="https://github.com/kulinar310" target="_blank">kulinar310</a></figcaption>
        </figure>
      </div>
      <div class="col-lg-2 col-md-4 col-sm-6 project-author">
        <figure>
          <img class="img-project-author" src="./imagesComponents/estel1591.jpeg" alt="estel1591">
          <figcaption>GitHub: <a href="https://github.com/estel1591" target="_blank">estel1591</a></figcaption>
        </figure>
      </div>
      <div class="col-lg-2 col-md-4 col-sm-6 project-author">
        <figure>
          <img class="img-project-author" src="./imagesComponents/niksrakevich.jpeg" alt="niksrakevich">

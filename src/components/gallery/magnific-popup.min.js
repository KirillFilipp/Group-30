...
!(function (a) {
  ...
  (t.prototype = {
    ...
    open(c) {
      ...
      (b.st.fixedBgPos === !1 || (b.st.fixedBgPos === 'auto' && !b.fixedContentPos))
  ...
  (a.fn.magnificPopup = function (c) {
    ...
    if (typeof c === 'string') {
      ...
      } else b.isOpen && b[c](...Array.prototype.slice.call(arguments, 1));
    } else {
      (c = a.extend(!0, {}, c)),
      ...
      findImageSize(a) {
        ...
        var e = function (f) {
          ...
          (L = setInterval(() => (d.naturalWidth > 0
            ...
            c++,
            void (c === 3 ? e(10) : c === 40 ? e(50) : c === 100 && e(500)))), f));
        };
        e(1);
      },
      getImage(c, d) {

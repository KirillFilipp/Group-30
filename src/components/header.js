...
<nav class='navbar navbar-expand-lg navbar-dark navbar-custom fixed-top'>
  <div class='container'>
    <span class='navbar-brand lang' key='title-search'>Режиссеры театра Беларуси</span>
    ...
    <div class='collapse navbar-collapse' id='navbarResponsive'>
      <ul class='navbar-nav ml-auto'>
        <li class='nav-item'>
          <a class='nav-link lang' key='main-page' href='${urlPath}/index.html'>Главная</a>
        </li>
        <li class='nav-item'>
          <a class='nav-link lang' key='search-page' href='${urlPath}/pages/search/index.html'>Список деятелей</a>
        </li>        
      </ul>
    </div>
    <div class='buttons'>
